...
export default function Homepage() {
  return (
    <>
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            ...
            <div className="w-full md:w-1/2 relative flex justify-center">
              <img
                ...
                src="/images/triple-infused-icon.png"
              />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 md:col-span-7 bg-surface-container h-[600px] relative group overflow-hidden">
            <img
              ...
              src="/images/hit-stick-product.jpg"
          ...
          <div className="col-span-12 md:col-span-5 bg-surface-container-high h-[600px] flex flex-col justify-end p-12 relative overflow-hidden group">
            <img
              ...
              src="/images/pre-rolls-product.jpg"
            />
            <div className="absolute inset-0 bg-black/40 group-hover:bg-black/20 transition-colors duration-500" />
          ...
          <div className="col-span-12 mt-6 relative h-[500px] overflow-hidden group">
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <img
                ...
                src="/images/ground-game-product.jpg"
              />
            </div>
      ...
      <section className="relative h-[80vh] flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img
            ...
            src="/images/apparel-lifestyle.jpg"
          />
          <div className="absolute inset-0 bg-black/60" />
        </div>
        <div className="container mx-auto px-12 relative z-10 text-center">
          <h2 className="font-headline text-8xl md:text-[10rem] font-black uppercase leading-[0.85] mb-6 text-white">
            THE APPAREL <br />
            COLLECTION
          </h2>
          ...
          <Link
            to="/apparel"
            className="inline-block bg-white text-black px-16 py-6 font-headline text-4xl font-bold uppercase hover:bg-primary-container transition-all"
          >
            SHOP NOW
          </Link>
        </div>
      ...
      <section className="bg-surface py-32 overflow-hidden border-t border-outline-variant/10">
        <div className="container mx-auto px-12 flex flex-col md:flex-row items-center gap-20">
          ...
          <div className="w-full md:w-1/2">
            ...
            <h2 className="font-headline text-8xl font-bold uppercase leading-[0.9] mb-8">
              RICKY <br />
              WILLIAMS
            </h2>
            ...
            <button className="border-2 border-primary text-primary px-12 py-4 font-headline text-2xl font-bold uppercase hover:bg-white hover:text-black transition-all">
              READ THE STORY
            </button>
          </div>
        </div>
      ...
      <div className="bg-white border-y border-black overflow-hidden whitespace-nowrap py-20 flex-col flex items-center">
        <h2 className="font-headline text-8xl font-black uppercase text-black mb-12 tracking-tighter">
          THE LINEUP
        </h2>
        <div className="flex w-full">
          <img
            ...
            src="/images/strains-banner.jpg"
          />
        </div>
        <div className="mt-12">
          <Link
            to="/our-strains"
            className="bg-black text-white px-16 py-5 font-headline text-3xl font-bold uppercase hover:bg-neutral-800 transition-colors inline-block"
          >
            VIEW THE LINEUP
          </Link>
        </div>
      ...
      {/* ===== STORE LOCATOR ===== */}
      <section className="py-32 bg-surface-container-lowest border-t border-outline-variant/10">
        <div className="container mx-auto px-12">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            <div className="w-full lg:w-1/2">
              <h2 className="font-headline text-[10rem] font-bold uppercase italic leading-[0.8] mb-8">
                find us near you
              </h2>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex flex-col md:flex-row items-stretch border border-primary/20">
                  <div className="flex-grow bg-surface p-6 flex items-center">
                    ...
                    <input
                      className="bg-transparent border-none text-white font-headline text-4xl focus:ring-0 placeholder:text-on-surface-variant/30 w-full uppercase"
                      placeholder="ZIP CODE OR CITY"
                      type="text"
                    />
                  </div>
                  <button className="bg-primary text-on-primary px-16 py-6 font-headline text-4xl font-bold uppercase hover:bg-primary-container transition-all">
                    SEARCH
                  </button>
                </div>
            ...
            <div className="w-full lg:w-1/2 h-[600px] bg-surface-container relative">
      ...
      <section className="bg-[#0E0E0E] py-24 border-t border-outline-variant/20">
        <div className="container mx-auto px-12 grid grid-cols-2 md:grid-cols-4 gap-12">
          {[
            ...
            >
              <span className="font-headline text-8xl font-bold text-primary leading-none">
                {stat.value}
              </span>
