...
const MERCH_ITEMS: MerchItem[] = [
  ...
  },
  {
    ...
    category: 'display-packaging',
    description: 'Empty replica of the Triple Threat 1.2g Pre-Roll tin. Same packaging, same shelf presence, no product. Built for window displays, counter showcases, and product education without tying up sellable inventory.',
  ...
  },
  {
    ...
    category: 'display-packaging',
    description: 'Empty replica of the Ground Game 7g Ready-to-Roll tin. Same packaging, same shelf presence, no product. Built for window displays, counter showcases, and product education without tying up sellable inventory.',
