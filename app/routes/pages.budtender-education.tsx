...
const COURSE_QUIZZES: Record<string, QuizQuestion[]> = {
  ...
  'product-training': [
    {
      q: 'Which specific combination of concentrates forms the \'triple-infused\' foundation found in Highsman products?',
      options: [
        'Live Rosin, Crumble, and CBD Isolate',
        'Liquid Diamonds, Hash Oil, and CO2 Extract',
        'THCA Diamonds, Live Resin, and High Terpene Extract (HTE)',
        'Kief, Distillate, and Botanical Terpenes',
      ],
      correct: 2,
      explanation: 'This specific trio of concentrates is used across the lineup to create a powerful, high-potency, and flavorful experience. Highsman avoids artificial additives in favor of centrifuge-infused concentrates.',
    },
    {
      q: 'How is the infusion applied to the flower in Highsman\'s Ground Game and Pre-rolls?',
      options: [
        'Spray-applied using a solvent-based atomizer',
        'Centrifuge-forced into the microstructure of whole flower',
        'Surface-coated and dusted with kief',
        'Hand-mixed with trim and shake before rolling',
      ],
      correct: 1,
      explanation: 'The centrifuge process ensures the infusion is deep within the flower\'s interior rather than just sitting on the surface. The brand identifies surface coating as a \'problem\' that leads to harsh burns and artificial tastes.',
    },
    {
      q: 'What is the intended usage and hit count for the patent-pending Highsman Hit Stick\u2122?',
      options: [
        'Quick, portable smoke providing 6-10 hits, then tossed',
        'Single large hit meant to be consumed like a \'one-hitter\'',
        'Rechargeable device meant for 50-100 hits',
        'Standard 1G pre-roll meant for a 20-minute session',
      ],
      correct: 0,
      explanation: 'The Hit Stick is designed for discreet, on-the-go use with a ceramic bowl that provides a specific number of hits. Hit Sticks are designed as \'Dispose-A-Bowls\' rather than long-term electronic hardware.',
    },
    {
      q: 'When using the Hit Stick, which proper technique should a budtender explain to a customer?',
      options: [
        'Break the stick in half and roll the contents into a joint',
        'Light the black paper stem and inhale from the white end',
        'Remove the ceramic tip and load it into a standard pipe',
        'Spark the white ceramic bowl end and inhale from the black paper stem',
      ],
      correct: 3,
      explanation: 'The white ceramic end is the \'Dispose-A-Bowl\' where the flower is ignited. The product is self-contained with engineered airflow, requiring no external hardware.',
    },
    {
      q: 'The \'Triple Threat\' pre-roll is marketed as having a \'Best Value\' because it contains how much flower?',
      options: ['2.0 grams', '1.0 gram', '0.5 grams', '1.2 grams'],
      correct: 3,
      explanation: 'Providing 1.2 grams offers 20% more product than standard pre-rolls at a competitive price point. Highsman positions the Triple Threat as superior to the \'standard\' 1 gram pre-roll often found on the market.',
    },
    {
      q: 'Which strain should a budtender recommend to a customer seeking full-body relaxation and a \'timeout\' experience?',
      options: ['Blueberry Blitz', 'Wavey Watermelon', 'Gridiron Grape', 'Cake Quake'],
      correct: 3,
      explanation: 'As an Indica, Cake Quake provides serenity and rejuvenation, making it ideal for recovery. Blueberry Blitz is a Hybrid for focus, Wavey Watermelon is a Sativa for energy, and Gridiron Grape is a Sativa for mental sharpness.',
    },
    {
      q: 'What is the primary customer \'problem\' that Ground Game (7G) is designed to solve?',
      options: [
        'Most consumers prefer shake and trim over whole flower',
        'Infused flower is typically too potent for the average user',
        'Customers are tired of grinding their own flower for pipes',
        'Customers want infused quality without paying high pre-roll prices',
      ],
      correct: 3,
      explanation: 'Ground Game offers 7 grams of triple-infused flower at a price point that beats buying individual pre-rolls. The brand markets the potency as a benefit (\'infused quality\') rather than a deterrent.',
    },
    {
      q: 'Which strain is described as a Hybrid with a \'zesty citrus kick\' and mango flavors to keep the user \'in the zone\'?',
      options: ['Blueberry Blitz', 'Cake Quake', 'Touchdown Tango Mango', 'Wavey Watermelon'],
      correct: 2,
      explanation: 'Touchdown Tango Mango specifically pairs mango with citrus notes to revitalize focus. Blueberry Blitz focuses on sweet berry flavors, Cake Quake features vanilla and creamy frosting as an Indica, and Wavey Watermelon is a Sativa with a crisp finish.',
    },
    {
      q: 'What physical hardware component is included in the Triple Threat pre-roll to prevent clogging and ensure a cool smoke?',
      options: [
        'A spiral-wound paper crutch',
        'A biodegradable corn husk filter',
        'A wooden filter',
        'A built-in glass tip',
      ],
      correct: 3,
      explanation: 'The glass tip is specifically designed for superior airflow, cooling the smoke and preventing clogs. Standard paper crutches are prone to the \'drag\' and \'clogging\' that the glass tip is intended to solve.',
    },
  ],
};
