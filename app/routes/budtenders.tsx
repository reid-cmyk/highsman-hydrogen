...
/* âââ Sticky Page Nav ââââââââââââââââââââââââ */
function StickyNav() {
  const [scrolled, setScrolled] = useState(false);
  const [active, setActive] = useState('');
  ...
  return (
    <nav
      ...
      aria-label="Page navigation"
    >
      <div className="max-w-6xl mx-auto px-6 md:px-16 flex items-center justify-between h-12 md:h-14">
        <a href="#top" className="focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-400" aria-label="Back to top">
          <img
            src={`${CDN}Highsman_Logo_White.png?v=1775594430`}
            alt="Highsman"
            className="h-6 md:h-7 transition-opacity"
        ...
        <div className="flex items-center gap-1 md:gap-2">
          {NAV_ITEMS.map(({label, href}) => (
            <a
              key={href}
              href={href}
              className="font-label text-[10px] md:text-[11px] tracking-[0.2em] uppercase px-2.5 md:px-4 py-1.5 transition-all focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-400"
              style={{
                color: active === href ? '#F5E100' : 'rgba(255,255,255,0.5)',
                background: active === href ? 'rgba(245,225,0,0.08)' : 'transparent',
              }}
            >
              {label}
            </a>
...
/* âââ Referral Form Component âââââââââââââââââ */
function ReferralForm() {
  const fetcher = useFetcher();
  const [submitted, setSubmitted] = useState(false);
  const isSubmitting = fetcher.state !== 'idle';
...
export default function Budtenders() {
  return (
    <>
      ...
      {/* âââ Scroll target for top ââââââââââââââââââââââââââââââââââââââââ */}
      <div id="top" />

      {/* âââ TOP BANNER IMAGE ââââââââââââââââââââââââââââââââââââââââââââââââ */}
      <section className="w-full" style={{background: '#000'}}>
        <img src="https://cdn.shopify.com/s/files/1/0752/8598/7491/files/Highsman_Budtenders_Only_Banner.png?v=1775671726" alt="Highsman Budtender â Budtenders Only" className="w-full h-auto block" />
      </section>
      ...
      <section className="relative min-h-screen flex flex-col justify-end overflow-hidden" style={{background: '#000'}}>
        ...
        <div className="relative z-10 px-8 md:px-16 pb-20 md:pb-28 max-w-6xl">
          ...
          {/* âââ TRAINING CAMP CTA ââââââââââââââââââââââââââââââââââ */}
          <a href="https://highsman.com/budtender-education" className="flex items-start gap-4 mb-10 transition-opacity hover:opacity-90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-yellow-400" style={{background: 'rgba(245,225,0,0.08)', border: '1px solid rgba(245,225,0,0.25)', padding: '16px 20px', maxWidth: '560px', textDecoration: 'none'}}>
            <div className="flex-shrink-0 w-1 self-stretch" style={{background: '#F5E100', minHeight: '40px'}} />
            <div>
              <p className="font-label text-[9px] tracking-[0.35em] uppercase mb-1" style={{color: '#F5E100'}}>Training Camp</p>
      ...
      <div style={{background: '#F5E100', borderBottom: '1px solid rgba(0,0,0,0.08)'}}>
        <div className="max-w-6xl mx-auto px-8 md:px-16 py-5 flex flex-wrap items-center justify-between gap-4">
          ...
          <img src={`${CDN}HM_SparkGreatness_Black.png?v=1775594430`} alt="Spark Greatnessâ¢" className="h-5 opacity-40" />
        </div>
      </div>

      {/* âââ RICKY SIGN-OFF (moved above prizes for credibility/emotional anchor) */}
      <section style={{background: '#000', borderBottom: '3px solid #F5E100'}}>
        <div className="max-w-6xl mx-auto px-8 md:px-16 py-20 md:py-24 md:grid md:grid-cols-[auto_1fr] md:gap-16 items-center">
          <img src={IMAGES.rickyWilliams} alt="Ricky Williams â Highsman Co-Founder" className="w-24 h-24 md:w-36 md:h-36 object-cover mb-10 md:mb-0 flex-shrink-0" style={{objectFit: 'cover', filter: 'grayscale(15%)'}} />
          <div>
            <blockquote className="font-headline uppercase tracking-tight mb-6" style={{fontSize: 'clamp(28px,4.5vw,56px)', lineHeight: 1.0, color: '#fff'}}>
      ...
      <section id="prizes" style={{background: '#0a0a0a'}}>
              ...
              <div className="mt-12 md:mt-0 md:pl-16 flex flex-col gap-5">
                <div>
                  ...
                  <div style={{background: '#111', border: '1px solid rgba(245,225,0,0.15)'}}>
                    <img src={`${CDN}Game_Day_Prize_Pic.svg?v=1775597075`} alt="Highsman Champions Box â all prize contents" className="w-full" style={{maxHeight: '340px', objectFit: 'contain', padding: '16px'}} />
                  </div>
                </div>
                <div>
        ...
        {/* 2nd & 3rd place â side by side with images first */}
        <div className="max-w-6xl mx-auto px-8 md:px-16 py-px">
          <div className="grid grid-cols-1 md:grid-cols-2" style={{gap: '1px', background: 'rgba(255,255,255,0.06)'}}>
            <div className="relative overflow-hidden p-10 md:p-12" style={{background: '#0a0a0a'}}>
              ...
              <div className="inline-block font-label text-[10px] tracking-[0.4em] uppercase px-3 py-1.5 mb-6" style={{background: '#C0C0C0', color: '#000'}}>Second Place</div>
              <h3 className="font-headline uppercase tracking-tight mb-6 text-white" style={{fontSize: 'clamp(34px,4vw,52px)', lineHeight: 0.88}}>Champions Box</h3>
            ...
            <div className="relative overflow-hidden p-10 md:p-12" style={{background: '#0a0a0a'}}>
              ...
              <div className="inline-block font-label text-[10px] tracking-[0.4em] uppercase px-3 py-1.5 mb-6" style={{background: '#CD7F32', color: '#000'}}>Third Place</div>
              <h3 className="font-headline uppercase tracking-tight mb-6 text-white" style={{fontSize: 'clamp(34px,4vw,52px)', lineHeight: 0.88}}>Varsity Jacket</h3>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="md:grid md:grid-cols-2">
            <div className="px-8 md:px-16 py-20 md:py-24 flex flex-col justify-center" style={{borderRight: '1px solid rgba(0,0,0,0.1)'}}>
              ...
              <h2 className="font-headline uppercase tracking-tight mb-8" style={{fontSize: 'clamp(60px,9vw,112px)', lineHeight: 0.82, color: '#000'}}>Win <br />Game Day <br />Tickets</h2>
              <p className="font-body text-lg leading-relaxed mb-10 max-w-sm" style={{color: 'rgba(0,0,0,0.65)'}}>
                <strong style={{color: '#000'}}>5 Champions Boxes include two tickets</strong>{' '}to an Eagles or Giants game â with the Highsman team. Game day with us. On us.
              </p>
              <div className="flex flex-col gap-3 pt-6" style={{borderTop: '1px solid rgba(0,0,0,0.12)'}}>
                {['Philadelphia Eagles', 'New York Giants'].map((team) => (
                  <span key={team} className="flex items-center gap-3 font-headline text-xs uppercase tracking-[0.22em]" style={{color: 'rgba(0,0,0,0.55)'}}>
            ...
            <div className="flex flex-col justify-center relative overflow-hidden" style={{background: '#000', minHeight: '440px'}}>
              ...
              <img src={`${CDN}Budtenders_Prize_Image_football_giveaway_9028f72e-b1c6-4cdb-a8b3-556663907532.png?v=1775599444`} alt="Football game day tickets â Eagles and Giants with Highsman" className="w-full" style={{maxHeight: '400px', objectFit: 'contain', padding: '24px 32px'}} />
              <div className="flex items-center gap-4 px-10 pb-8">
                <div className="h-px flex-1" style={{background: 'rgba(245,225,0,0.15)'}} />
                <span className="font-label text-[9px] tracking-[0.3em] uppercase" style={{color: 'rgba(245,225,0,0.4)'}}>Highsman &middot; NJ</span>
                <div className="h-px flex-1" style={{background: 'rgba(245,225,0,0.15)'}} />
      ...
      <div style={{background: '#000', borderTop: '1px solid rgba(255,255,255,0.06)'}}>
        <div className="max-w-6xl mx-auto px-8 md:px-16 py-10 flex items-center justify-between flex-wrap gap-4">
          <img src={`${CDN}Spark_Greatness_White.png?v=1775594430`} alt="Spark Greatnessâ¢" className="h-5 opacity-40" />
          <p className="font-label text-[10px] tracking-[0.2em] uppercase" style={{color: 'rgba(255,255,255,0.25)'}}>&copy; 2026 Highsman. All rights reserved.</p>
        </div>
      </div>
    </>
